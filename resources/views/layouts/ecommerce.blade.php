...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container">
				<a class="navbar-brand" href="#">Goldenskin</a>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
								...
								<a class="dropdown-item" href="{{ route('customer.logout') }}">Keluar</a>
								@else
								<a class="dropdown-item" href="{{ route('customer.login') }}">Masuk</a>
